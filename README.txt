The coding environment of this project is on OSX Yosemite V10.10.1 with Xcode V6.2. The flying bee project was coding on the template provided in Proj zero. The folder includes Xcode project file and another folder includes all the header and source files needed for compile the project. 
